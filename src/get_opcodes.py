...
Options:
    --all                       --valid     (default) print all valid opcodes
    --terminating-opcodes       -to         print all terminating opcodes
    --non-terminating-opcodes   -nto        print all non-terminating opcodes
"""
